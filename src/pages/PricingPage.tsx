...
import { Check, Crown, Shield, CreditCard, Clock, Gift, ArrowLeft, ArrowRight, ChevronDown, ChevronUp, Sparkles, Lock } from 'lucide-react';
...
const PricingPage: React.FC = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'We accept all major credit cards, debit cards, and Apple Pay through our secure Stripe payment processor.'
    }
  ];
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="pt-24 pb-12 px-4 bg-white">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex items-center justify-center gap-3 mb-10">
            <span className={`text-sm font-medium ${billingCycle === 'monthly' ? 'text-gray-800' : 'text-gray-400'}`}>
              Monthly
            </span>
            <button
              onClick={() => setBillingCycle(billingCycle === 'monthly' ? 'yearly' : 'monthly')}
              className={`relative w-14 h-7 rounded-full transition-colors ${
                billingCycle === 'yearly' ? 'bg-[#7C9885]' : 'bg-gray-300'
              }`}
            >
            ...
            <span className={`text-sm font-medium ${billingCycle === 'yearly' ? 'text-gray-800' : 'text-gray-400'}`}>
              Annual
            </span>
            {billingCycle === 'yearly' && (
      ...
      <div className="px-4 py-12">
        <div className="max-w-4xl mx-auto">
          ...
          {/* Trust Badges */}
          <div className="flex items-center justify-center gap-6 mt-10 flex-wrap text-sm text-gray-500">
      ...
      {/* CTA Section */}
      <div className="px-4 py-16 bg-gradient-to-r from-[#7C9885] to-[#5a7a64]">
        <div className="max-w-2xl mx-auto text-center text-white">
          ...
          <button
            onClick={handleStartTrial}
            className="px-8 py-4 bg-white text-[#7C9885] rounded-xl font-semibold hover:bg-gray-100 transition-colors shadow-lg inline-flex items-center gap-2"
          >
            Start Free Trial
